...
<input type='text' readonly value='".$row['Catagory']."' name='cat' style='margin-top:10px;height:50px;width:400px'/></br>

<input type='text' readonly  value='".$row['Location']."'  name='loc'  style='margin-top:50px;height:50px;width:400px;'/><br>
<input type='number' readonly value='".$row['Price']."'  name='price'style='margin-top:50px;height:50px;width:100px;float:left'/>
<p style='float:left;font-size:30px;margin-top:50px;color:green'>$</p>
<div style='float:left;width:200px'>.</div>
<input type='number' readonly value='".$row['Number']."' name='num' style='margin-top:50px;height:50px;width:200px;float:left'/></br></br></br></br></br>
<input type='submit' value='Delet Item' class='btn btn-danger' />
</form>
