...
<button class="btn btn-warning" style="width:260;margin:20;height:40px">Remove Item</button>
...
<div style="width:20%;height:60px;border-top:solid 2px;float:left;border-right:solid 2px;text-align:center"><p style="font-size:30px;color:black">Item Delete</p> </div>
<div style="width:80%;height:60px;border-bottom:solid 2px;float:right"> </div>
<form action="Dhandler.php" method="POST">
<input type="Number" placeholder="ID"  name='id'    style="margin-top:50px;height:50px;width:60px;float:left"/>
<input type="submit" value="Search" class="btn btn-success" style="margin-top:50px;height:50px;width:100px;float:left" /></form></br></br></br></br></br></br>
<p>.</p>
<input type="text" placeholder="Item category" style="margin-top:10px;height:50px;width:400px"/></br>

<input type="text" placeholder="Location"      style="margin-top:50px;height:50px;width:400px;"/><br>
<input type="number" placeholder="Item Price" style="margin-top:50px;height:50px;width:100px;float:left"/>
<p style="float:left;font-size:30px;margin-top:50px;color:green">$</p>
<div style="float:left;width:200px">.</div>
<input type="number" placeholder="Amount in stalk" style="margin-top:50px;height:50px;width:200px;float:left"/></br></br></br></br></br>
